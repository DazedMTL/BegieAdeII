            ...
            (i.createList = function (e) {
              if ("list" in e) {
                ...
                if (
                  ((n = a =
                    new i(
                      "string" == typeof o ? t.ParticleUtils.hexToRGB(o) : o,
                      h,
                      e.ease
                    )),
                  s.length > 2 || (2 === s.length && s[1].value !== o))
                )
                  for (var l = 1; l < s.length; ++l) {
                    var p = s[l],
                      ...
                      u = p.time;
                    (a.next = new i(
                      "string" == typeof c ? t.ParticleUtils.hexToRGB(c) : c,
                      u
                    )),
                      (a = a.next);
                  }
          ...
          (t.prototype.reset = function (t) {
            (this.current = t),
              ...
              this.next && this.next.time >= 1
                ...
                : t.isStepped
                ? (this.interpolate = this.isColor ? d : m)
        ...
        x = (function (e) {
          function s(t) {
            ...
            return (
              ...
              (a.velocity = new i.Point()),
              (a.rotationSpeed = 0),
              (a.rotationAcceleration = 0),
              (a.maxLife = 0),
              (a.age = 0),
              (a.ease = null),
              (a.extraData = null),
              ...
              (a._doAcceleration = !1),
              (a._doColor = !1),
              (a._doNormalMovement = !1),
              (a._oneOverLife = 0),
              (a.next = null),
              (a.prev = null),
              (a.init = a.init),
              (a.Particle_init = s.prototype.init),
              (a.update = a.update),
              (a.Particle_update = s.prototype.update),
              (a.Sprite_destroy = e.prototype.destroy),
              (a.Particle_destroy = s.prototype.destroy),
              (a.applyArt = a.applyArt),
              (a.kill = a.kill),
              a
            );
          }
              ...
              if (this._doNormalMovement) {
                ...
                if (this._doSpeed) {
                  ...
                  t.ParticleUtils.normalize(this.velocity),
                    t.ParticleUtils.scaleBy(this.velocity, r),
                    (a = this.velocity.x * i),
                    (n = this.velocity.y * i);
                  ...
                  (a = ((o + this.velocity.x) / 2) * i),
                    (n = ((h + this.velocity.y) / 2) * i);
            ...
            (t.prototype.init = function (t) {
              ...
              for (i = 0; i < this.segments.length; ++i) {
                var r = this.segments[i],
                  ...
                  h = r.p2,
                  l = Math.sqrt(
                    (h.x - o.x) * (h.x - o.x) + (h.y - o.y) * (h.y - o.y)
                  );
                (this.segments[i].l = l),
                  (this.totalLength += l),
              ...
              if (1 === this.segments.length) (i = this.segments[0]), (e = s);
                ...
                for (var a = 0; a < this.countingLengths.length; ++a)
                  if (s < this.countingLengths[a]) {
                    (i = this.segments[a]),
                      (e = 0 === a ? s : s - this.countingLengths[a - 1]);
                    break;
                  }
              e /= i.l || 1;
              var n = i.p1,
        ...
        P = (function () {
          ...
          return (
            ...
            (e.prototype.init = function (e, a) {
              if (e && a) {
                ...
                (this.particleImages = n.parseArt ? n.parseArt(e) : e),
                  a.alpha
                    ? (this.startAlpha = s.createList(a.alpha))
                    : (this.startAlpha = new s(1, 0)),
                  a.speed
                    ? ((this.startSpeed = s.createList(a.speed)),
                      (this.minimumSpeedMultiplier =
                        ("minimumSpeedMultiplier" in a
                          ? a.minimumSpeedMultiplier
                          : a.speed.minimumSpeedMultiplier) || 1))
                    : ((this.minimumSpeedMultiplier = 1),
                      (this.startSpeed = new s(0, 0)));
                var r = a.acceleration;
                r && (r.x || r.y)
                  ? ((this.startSpeed.next = null),
                    (this.acceleration = new i.Point(r.x, r.y)),
                    (this.maxSpeed = a.maxSpeed || NaN))
                  : (this.acceleration = new i.Point()),
                  a.scale
                    ? ((this.startScale = s.createList(a.scale)),
                      (this.minimumScaleMultiplier =
                        ("minimumScaleMultiplier" in a
                          ? a.minimumScaleMultiplier
                          : a.scale.minimumScaleMultiplier) || 1))
                    : ((this.startScale = new s(1, 0)),
                      (this.minimumScaleMultiplier = 1)),
                  a.color
                    ? (this.startColor = s.createList(a.color))
                    : (this.startColor = new s({ r: 255, g: 255, b: 255 }, 0)),
                  a.startRotation
                    ? ((this.minStartRotation = a.startRotation.min),
                      (this.maxStartRotation = a.startRotation.max))
                    : (this.minStartRotation = this.maxStartRotation = 0),
                  a.noRotation &&
                  (this.minStartRotation || this.maxStartRotation)
                    ? (this.noRotation = !!a.noRotation)
                    : (this.noRotation = !1),
                  a.rotationSpeed
                    ? ((this.minRotationSpeed = a.rotationSpeed.min),
                      (this.maxRotationSpeed = a.rotationSpeed.max))
                    : (this.minRotationSpeed = this.maxRotationSpeed = 0),
                  (this.rotationAcceleration = a.rotationAcceleration || 0),
                  (this.minLifetime = a.lifetime.min),
                  (this.maxLifetime = a.lifetime.max),
                  (this.particleBlendMode = t.ParticleUtils.getBlendMode(
                    a.blendMode
                  )),
                  a.ease
                    ? (this.customEase =
                        "function" == typeof a.ease
                          ? a.ease
                          : t.ParticleUtils.generateEase(a.ease))
                    : (this.customEase = null),
                  n.parseData
                    ? (this.extraData = n.parseData(a.extraData))
                    : (this.extraData = a.extraData || null),
                  (this.spawnRect = this.spawnCircle = null),
                  (this.particlesPerWave = 1),
                  a.particlesPerWave &&
                    a.particlesPerWave > 1 &&
                    (this.particlesPerWave = a.particlesPerWave),
                  (this.particleSpacing = 0),
                  (this.angleStart = 0),
                  this.parseSpawnType(a),
                  (this.frequency = a.frequency),
                  (this.spawnChance =
                    "number" == typeof a.spawnChance && a.spawnChance > 0
                      ? a.spawnChance
                      : 1),
                  (this.emitterLifetime = a.emitterLifetime || -1),
                  (this.maxParticles =
                    a.maxParticles > 0 ? a.maxParticles : 1e3),
                  (this.addAtBack = !!a.addAtBack),
                  (this.rotation = 0),
                  (this.ownerPos = new i.Point()),
                  (this.spawnPos = new i.Point(a.pos.x, a.pos.y)),
                  this.initAdditional(e, a),
                  (this._prevEmitterPos = this.spawnPos.clone()),
                  (this._prevPosIsValid = !1),
                  (this._spawnTimer = 0),
                  (this.emit = void 0 === a.emit || !!a.emit),
                  (this.autoUpdate = !!a.autoUpdate),
                  (this.orderedArt = !!a.orderedArt);
              }
            }),
              ...
              switch (t.spawnType) {
                ...
                case "polygonalChain":
                  (this.spawnType = "polygonalChain"),
                    ...
                    (this.spawnPolygonalChain = new y(t.spawnPolygon));
                  break;
                default:
                  (this.spawnType = "point"),
                    (this._spawnFunc = this._spawnPoint);
            ...
            Object.defineProperty(e.prototype, "autoUpdate", {
              ...
              set: function (t) {
                this._autoUpdate && !t
                  ? f.remove(this.update, this)
                  : !this._autoUpdate && t && f.add(this.update, this),
                  (this._autoUpdate = !!t);
              },
              enumerable: !0,
              configurable: !0,
            ...
            (e.prototype.update = function (t) {
              if (
                ...
                var e, s, a, n, r;
                for (s = this._activeParticlesFirst; s; s = a)
                  (a = s.next), s.update(t);
                this._prevPosIsValid &&
                  ((n = this._prevEmitterPos.x), (r = this._prevEmitterPos.y));
            ...
            (e.prototype._spawnRect = function (i, e, s) {
              this.minStartRotation == this.maxStartRotation
                ...
                : (i.rotation =
                    ...
                    this.minStartRotation +
                    this.rotation),
                (v.x = Math.random() * this.spawnRect.width + this.spawnRect.x),
                (v.y =
                  Math.random() * this.spawnRect.height + this.spawnRect.y),
                0 !== this.rotation &&
                  t.ParticleUtils.rotatePoint(this.rotation, v),
                (i.position.x = e + v.x),
                (i.position.y = s + v.y);
            }),
            (e.prototype._spawnCircle = function (i, e, s) {
              this.minStartRotation == this.maxStartRotation
                ...
                : (i.rotation =
                    ...
                    this.minStartRotation +
                    this.rotation),
                (v.x = Math.random() * this.spawnCircle.radius),
                (v.y = 0),
                t.ParticleUtils.rotatePoint(360 * Math.random(), v),
                (v.x += this.spawnCircle.x),
                (v.y += this.spawnCircle.y),
                0 !== this.rotation &&
                  t.ParticleUtils.rotatePoint(this.rotation, v),
                (i.position.x = e + v.x),
                (i.position.y = s + v.y);
            ...
            (e.prototype._spawnRing = function (i, e, s) {
              ...
              (i.rotation += n),
                t.ParticleUtils.rotatePoint(n, v),
                (v.x += this.spawnCircle.x),
                (v.y += this.spawnCircle.y),
                0 !== this.rotation &&
                  t.ParticleUtils.rotatePoint(this.rotation, v),
            ...
            (e.prototype._spawnPolygonalChain = function (i, e, s) {
              this.minStartRotation == this.maxStartRotation
                ...
                : (i.rotation =
                    ...
                    this.minStartRotation +
                    this.rotation),
                this.spawnPolygonalChain.getRandomPoint(v),
                0 !== this.rotation &&
                  t.ParticleUtils.rotatePoint(this.rotation, v),
                (i.position.x = e + v.x),
                (i.position.y = s + v.y);
        ...
        C = (function (t) {
          ...
          return (
            ...
            (e.parseArt = function (t) {
              for (var e, s, a, r, o, h = [], l = 0; l < t.length; ++l) {
                (e = t[l]),
                  (h[l] = s = {}),
                  (s.textures = o = []),
                  (a = e.textures);
                for (var p = 0; p < a.length; ++p)
                  if ("string" == typeof (r = a[p])) o.push(n(r));
                  else if (r instanceof i.Texture) o.push(r);
                  else {
                    var c = r.count || 1;
                    for (
                      r =
                        "string" == typeof r.texture ? n(r.texture) : r.texture;
                      c > 0;
                      --c
                    )
                      o.push(r);
                ...
                "matchLife" == e.framerate
                  ? ((s.framerate = -1), (s.duration = 0), (s.loop = !1))
                  : ((s.loop = !!e.loop),
                    (s.framerate = e.framerate > 0 ? e.framerate : 60),
                    (s.duration = o.length / s.framerate));
              }
              return h;
            }),
            e
...
***************************************************************************** */
  ...
  var commandNames = (
    parameters["commandName"] || "particle,パーティクル"
  ).split(",");
...
===================================*/
  ...
  Game_Particle.prototype.particleSet = function (
    ...
    if (errorLog && target === undefined) {
      throw new Error(
        "パーティクル表示コマンドの対象が設定されてません。(ID:" + id + ")"
      );
    }
    ...
    if (target instanceof PIXI.Container) {
      ...
      if (errorLog && targetType < 0) {
        throw new Error(
          "対象のシーンが登録されてませんされてません。(対象:" + target + ")"
        );
      }
      ...
      if (targetElems[0] === "follower") {
        ...
        targetElems[0] === "walk" ||
        targetElems[0].toLowerCase() === "startdash"
      ) {
...
===================================*/
  ...
  Game_Particle.prototype.removeParticlesWithTargetTypes = function (
    types,
    checker
  ) {
...
===================================*/
  ...
  ParticleEmitter.prototype.initialize = function (id, data) {
    ...
    for (var i = 0; i < length; i = (i + 1) | 0) {
      bitmaps[i].addLoadListener(
        ParticleEmitter.prototype.tryStart.bind(this, bitmaps)
      );
    }
  };
  ...
  ParticleEmitter.prototype.initMembers = function () {
    ...
    this._characterTargetMargin = isNaN(outsideMargin)
      ? -1
      : ParticleEmitter.TILE_SIZE * Number(outsideMargin);
      ...
      if (target instanceof Game_Event) {
        if (target.event().meta.pMargin !== undefined) {
          this._characterTargetMargin =
            ParticleEmitter.TILE_SIZE * Number(target.event().meta.pMargin);
        }
      }
    }
  };
...
===================================*/
  ...
  ParticleEmitter.prototype.changeImage = function (image) {
    ...
    for (var i = 0; i < length; i = (i + 1) | 0) {
      bitmaps[i].addLoadListener(
        ParticleEmitter.prototype._tryChangeImage.bind(this, bitmaps)
      );
    }
  };
...
===================================*/
  ParticleEmitter.prototype.updateCharacterOutsideFreeze = function (x, y) {
    ...
    if (
      x < -margin ||
      x > Graphics.boxWidth + margin ||
      y < -margin ||
      y > Graphics.boxHeight + margin
    ) {
      this._freezed = true;
    } else {
      this._freezed = false;
...
===================================*/
  Game_Interpreter.prototype.trpParticleTest = function () {
    ...
    var list = [
      ...
      { code: 356, indent: 0, parameters: ["particle set light_r region:1"] },
      { code: 230, indent: 0, parameters: [90] },
      { code: 356, indent: 0, parameters: ["particle clear light_r"] },
      { code: 101, indent: 0, parameters: ["", 0, 0, 2] },
  ...
  Game_Interpreter.prototype.trpParticleTest2 = function () {
    ...
    var list = [
      { code: 101, indent: 0, parameters: ["", 0, 0, 2] },
      {
        code: 401,
        indent: 0,
        parameters: ["\\>パーティクルエディタの動作テストを行います。"],
      },
