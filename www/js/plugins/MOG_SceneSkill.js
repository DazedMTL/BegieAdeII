...
Moghunter.scSkill_ItemWindowWidth = Number(
  Moghunter.parameters["List Width"] || 370
);
Moghunter.scSkill_ItemWindowHeight = Number(
  Moghunter.parameters["List Height"] || 370
);
Moghunter.scSkill_ItemWindowX = Number(
  Moghunter.parameters["List X-Axis"] || 0
);
Moghunter.scSkill_ItemWindowY = Number(
  Moghunter.parameters["List Y-Axis"] || 126
);
Moghunter.scSkill_WlayoutX = Number(
  Moghunter.parameters["List Layout X-Axis"] || -33
);
Moghunter.scSkill_WlayoutY = Number(
  Moghunter.parameters["List Layout Y-Axis"] || -56
);
Moghunter.scSkill_TypeWindowWidth = Number(
  Moghunter.parameters["Type Width"] || 210
);
Moghunter.scSkill_TypeWindowHeight = Number(
  Moghunter.parameters["Type Height"] || 180
);
Moghunter.scSkill_TypeWindowX = Number(
  Moghunter.parameters["Type X-Axis"] || 0
);
Moghunter.scSkill_TypeWindowY = Number(
  Moghunter.parameters["Type Y-Axis"] || 200
);
Moghunter.scSkill_TlayoutX = Number(
  Moghunter.parameters["Type Layout X-Axis"] || 0
);
Moghunter.scSkill_TlayoutY = Number(
  Moghunter.parameters["Type Layout Y-Axis"] || -10
);
Moghunter.scSkill_HelpWindowX = Number(
  Moghunter.parameters["Help X-Axis"] || 0
);
Moghunter.scSkill_HelpWindowY = Number(
...
Moghunter.scSkill_AS_FaceX = Number(
  Moghunter.parameters["SW Face X-Axis"] || 10
);
Moghunter.scSkill_AS_FaceY = Number(
  Moghunter.parameters["SW Face Y-Axis"] || 15
);
...
Moghunter.scSkill_AS_ParFontSize = Number(
  Moghunter.parameters["SW Par FontSize"] || 22
);
Moghunter.scSkill_AS_MeterHPX = Number(
  Moghunter.parameters["SW HP Meter X-Axis"] || 88
);
Moghunter.scSkill_AS_MeterHPY = Number(
  Moghunter.parameters["SW HP Meter Y-Axis"] || 38
);
Moghunter.scSkill_AS_MeterMPX = Number(
  Moghunter.parameters["SW MP Meter X-Axis"] || 187
);
Moghunter.scSkill_AS_MeterMPY = Number(
  Moghunter.parameters["SW MP Meter Y-Axis"] || 38
);
Moghunter.scSkill_AS_StatesX = Number(
  Moghunter.parameters["SW States X-Axis"] || 214
);
Moghunter.scSkill_AS_StatesY = Number(
  Moghunter.parameters["SW States Y-Axis"] || 51
);
Moghunter.scSkill_ActorWinX = Number(
  Moghunter.parameters["Actor Windows X-Axis"] || 600
);
Moghunter.scSkill_ActorWinY = Number(
  Moghunter.parameters["Actor Windows Y-Axis"] || 200
);
Moghunter.scSkill_PartyX = Number(
  Moghunter.parameters["Party Window X-Axis"] || 10
);
Moghunter.scSkill_PartyY = Number(
...
Scene_Skill.prototype.updateActorStatusWindow = function () {
  if (this._ActorStatusWindow.y < this._ActorOrg[1]) {
    ...
    if (this._ActorStatusWindow.y > this._ActorOrg[1]) {
      this._ActorStatusWindow.y = this._ActorOrg[1];
    }
  }
...
Scene_Skill.prototype.updateCommands = function () {
  ...
  if (this._itemWindow.active) {
    ...
    if (this._skillTypeIndex != this._skillTypeWindow._index) {
      this.refreshTypeIndex();
    }
  }
};
...
Scene_Skill.prototype.addCatIndex = function (value) {
  ...
  if (this._skillTypeWindow._index >= this._skillTypeWindow.maxItems()) {
    this._skillTypeWindow._index = 0;
  }
  if (this._skillTypeWindow._index < 0) {
    this._skillTypeWindow._index = this._skillTypeWindow.maxItems() - 1;
  }
  if (this._wani[2] != null) {
    this._skillTypeWindow._index = this._wani[2];
  }
...
Scene_Skill.prototype.waniSlideRight = function () {
  if (this._wani[1] === 0) {
    ...
    if (
      this._skillTypeWindow.active &&
      this._itemWindow.contentsOpacity > 160
    ) {
      this._itemWindow.contentsOpacity = 160;
    }
  }
...
Scene_Skill.prototype.createPartyData = function () {
  ...
  this._partyPos[1] = [
    Moghunter.scSkill_PartyX - 290,
    Moghunter.scSkill_PartyY,
  ];
  this._partyPos[2] = [
    Moghunter.scSkill_PartyX - 20,
    Moghunter.scSkill_PartyY - 100,
  ];
  this._partyPos[3] = [
    Moghunter.scSkill_PartyX - 20,
    Moghunter.scSkill_PartyY + 100,
...
ActorStatusSkill.prototype.refreshFace = function () {
  this._face.bitmap = ImageManager.loadMenusFaces2(
