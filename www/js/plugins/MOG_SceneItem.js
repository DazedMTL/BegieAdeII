...
Moghunter.scItem_PartyTPNumberX = Number(Moghunter.parameters['Party TPNumber X-Axis'] || 118);
Moghunter.scItem_PartyTPNumberY = Number(Moghunter.parameters['Party TPNumber Y-Axis'] || 3);
...
Moghunter.scItem_PartyTPMeterX = Number(Moghunter.parameters['Party TPMeter X-Axis'] || 113);
Moghunter.scItem_PartyTPMeterY = Number(Moghunter.parameters['Party TPMeter Y-Axis'] || 30);
Moghunter.scItem_PartyStatusX = Number(Moghunter.parameters['Party Status X-Axis'] || 165);
Moghunter.scItem_PartyStatusY = Number(Moghunter.parameters['Party Status Y-Axis'] || 39);
...
PartyWindowData.prototype.refreshPar = function () {
	...
	this._par.bitmap.drawText(this._actor.tp, Moghunter.scItem_PartyTPNumberX, Moghunter.scItem_PartyTPNumberY, 80, 32, "right");
