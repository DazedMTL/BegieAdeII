...
Moghunter.scStatus_StatesX = Number(
  Moghunter.parameters["States X-Axis"] || 59
);
Moghunter.scStatus_StatesY = Number(
  Moghunter.parameters["States Y-Axis"] || 120
);
Moghunter.scStatus_ActorNameX = Number(
  Moghunter.parameters["Name X-Axis"] || 190
);
Moghunter.scStatus_ActorNameY = Number(
  Moghunter.parameters["Name Y-Axis"] || 103
);
...
Moghunter.scStatus_NExpX = Number(
  Moghunter.parameters["Next Exp X-Axis"] || 680
);
Moghunter.scStatus_NExpY = Number(Moghunter.parameters["Next Exp Y-Axis"] || 6);
Moghunter.scStatus_HPNumberX = Number(
  Moghunter.parameters["HP Number X-Axis"] || 50
);
Moghunter.scStatus_HPNumberY = Number(
  Moghunter.parameters["HP Number Y-Axis"] || 155
);
Moghunter.scStatus_MeterHPX = Number(
  Moghunter.parameters["HP Meter X-Axis"] || 45
);
Moghunter.scStatus_MeterHPY = Number(
  Moghunter.parameters["HP Meter Y-Axis"] || 210
);
Moghunter.scStatus_MPNumberX = Number(
  Moghunter.parameters["MP Number X-Axis"] || 208
);
Moghunter.scStatus_MPNumberY = Number(
  Moghunter.parameters["MP Number Y-Axis"] || 155
);
Moghunter.scStatus_MeterMPX = Number(
  Moghunter.parameters["MP Meter X-Axis"] || 203
);
Moghunter.scStatus_MeterMPY = Number(
  Moghunter.parameters["MP Meter Y-Axis"] || 210
);
Moghunter.scStatus_TPNumberX = Number(
  Moghunter.parameters["TP Number X-Axis"] || 366
);
Moghunter.scStatus_TPNumberY = Number(
  Moghunter.parameters["TP Number Y-Axis"] || 155
);
Moghunter.scStatus_MeterTPX = Number(
  Moghunter.parameters["TP Meter X-Axis"] || 361
);
Moghunter.scStatus_MeterTPY = Number(
  Moghunter.parameters["TP Meter Y-Axis"] || 210
);
Moghunter.scStatus_ATKNumberX = Number(
  Moghunter.parameters["ATK Number X-Axis"] || 50
);
Moghunter.scStatus_ATKNumberY = Number(
  Moghunter.parameters["ATK Number Y-Axis"] || 211
);
Moghunter.scStatus_MeterATKX = Number(
  Moghunter.parameters["ATK Meter X-Axis"] || 45
);
Moghunter.scStatus_MeterATKY = Number(
  Moghunter.parameters["ATK Meter Y-Axis"] || 266
);
Moghunter.scStatus_MATNumberX = Number(
  Moghunter.parameters["MAT Number X-Axis"] || 208
);
Moghunter.scStatus_MATNumberY = Number(
  Moghunter.parameters["MAT Number Y-Axis"] || 211
);
Moghunter.scStatus_MeterMATX = Number(
  Moghunter.parameters["MAT Meter X-Axis"] || 203
);
Moghunter.scStatus_MeterMATY = Number(
  Moghunter.parameters["MAT Meter Y-Axis"] || 266
);
Moghunter.scStatus_AGINumberX = Number(
  Moghunter.parameters["AGI Number X-Axis"] || 366
);
Moghunter.scStatus_AGINumberY = Number(
  Moghunter.parameters["AGI Number Y-Axis"] || 211
);
Moghunter.scStatus_MeterAGIX = Number(
  Moghunter.parameters["AGI Meter X-Axis"] || 361
);
Moghunter.scStatus_MeterAGIY = Number(
  Moghunter.parameters["AGI Meter Y-Axis"] || 266
);
Moghunter.scStatus_DEFNumberX = Number(
  Moghunter.parameters["DEF Number X-Axis"] || 50
);
Moghunter.scStatus_DEFNumberY = Number(
  Moghunter.parameters["DEF Number Y-Axis"] || 267
);
Moghunter.scStatus_MeterDEFX = Number(
  Moghunter.parameters["DEF Meter X-Axis"] || 45
);
Moghunter.scStatus_MeterDEFY = Number(
  Moghunter.parameters["DEF Meter Y-Axis"] || 322
);
Moghunter.scStatus_MDFNumberX = Number(
  Moghunter.parameters["MDF Number X-Axis"] || 208
);
Moghunter.scStatus_MDFNumberY = Number(
  Moghunter.parameters["MDF Number Y-Axis"] || 267
);
Moghunter.scStatus_MeterMDFX = Number(
  Moghunter.parameters["MDF Meter X-Axis"] || 203
);
Moghunter.scStatus_MeterMDFY = Number(
  Moghunter.parameters["MDF Meter Y-Axis"] || 322
);
Moghunter.scStatus_LUKNumberX = Number(
  Moghunter.parameters["LUK Number X-Axis"] || 366
);
Moghunter.scStatus_LUKNumberY = Number(
  Moghunter.parameters["LUK Number Y-Axis"] || 267
);
Moghunter.scStatus_MeterLUKX = Number(
  Moghunter.parameters["LUK Meter X-Axis"] || 361
);
Moghunter.scStatus_MeterLUKY = Number(
  Moghunter.parameters["LUK Meter Y-Axis"] || 322
);
Moghunter.scStatus_WeaponX = Number(Moghunter.parameters["Weapon X-Axis"] || 7);
Moghunter.scStatus_WeaponY = Number(
  Moghunter.parameters["Weapon Y-Axis"] || 347
);
Moghunter.scStatus_ShieldX = Number(Moghunter.parameters["Shield X-Axis"] || 7);
Moghunter.scStatus_ShieldY = Number(
  Moghunter.parameters["Shield Y-Axis"] || 398
);
Moghunter.scStatus_HelmetX = Number(Moghunter.parameters["Helmet X-Axis"] || 7);
Moghunter.scStatus_HelmetY = Number(
  Moghunter.parameters["Helmet Y-Axis"] || 449
);
...
Moghunter.scStatus_AccX = Number(
  Moghunter.parameters["Accessory X-Axis"] || 261
);
Moghunter.scStatus_AccY = Number(
  Moghunter.parameters["Accessory Y-Axis"] || 427
);
...
Moghunter.scStatus_ProfileX = Number(
  Moghunter.parameters["Profile X-Axis"] || 0
);
Moghunter.scStatus_ProfileY = Number(
  Moghunter.parameters["Profile Y-Axis"] || 505
);
...
Scene_Status.prototype.refreshBust = function () {
  this._bust.bitmap = ImageManager.loadMenusFaces4(
...
Window_Status.prototype.refresh = function () {
  ...
  if (this._actor) {
    ...
    this.drawText(
      this._actor.name(),
      Moghunter.scStatus_ActorNameX,
      Moghunter.scStatus_ActorNameY,
      120,
      "center"
    );
    this.drawText(
      this._actor.level,
      Moghunter.scStatus_LevelX,
      Moghunter.scStatus_LevelY,
      100,
      "center"
    );
    this.drawText(
      this._actor.currentExp(),
      Moghunter.scStatus_ExpX,
      Moghunter.scStatus_ExpY,
      100,
      "center"
    );
    ...
    this.drawText(
      nexp,
      Moghunter.scStatus_NExpX,
      Moghunter.scStatus_NExpY,
      100,
      "center"
    );
    ...
    this.drawText(
      ...
      Moghunter.scStatus_HPNumberX,
      Moghunter.scStatus_HPNumberY,
      100,
      "right"
    );
    this.drawText(
      ...
      Moghunter.scStatus_MPNumberY,
      100,
      "right"
    );
    this.drawText(
      this._actor.tp,
      Moghunter.scStatus_TPNumberX,
      Moghunter.scStatus_TPNumberY,
      100,
      "right"
    );
    this.drawText(
      this._actor.atk,
      Moghunter.scStatus_ATKNumberX,
      Moghunter.scStatus_ATKNumberY,
      100,
      "right"
    );
    this.drawText(
      this._actor.mat,
      Moghunter.scStatus_MATNumberX,
      Moghunter.scStatus_MATNumberY,
      100,
      "right"
    );
    this.drawText(
      this._actor.agi,
      Moghunter.scStatus_AGINumberX,
      Moghunter.scStatus_AGINumberY,
      100,
      "right"
    );
    this.drawText(
      this._actor.def,
      Moghunter.scStatus_DEFNumberX,
      Moghunter.scStatus_DEFNumberY,
      100,
      "right"
    );
    this.drawText(
      this._actor.mdf,
      Moghunter.scStatus_MDFNumberX,
      Moghunter.scStatus_MDFNumberY,
      100,
      "right"
    );
    this.drawText(
      this._actor.luk,
      Moghunter.scStatus_LUKNumberX,
      Moghunter.scStatus_LUKNumberY,
      100,
      "right"
    );
    this.drawItemName(
      this._actor.equips()[0],
      Moghunter.scStatus_WeaponX,
      Moghunter.scStatus_WeaponY
    );
    this.drawItemName(
      this._actor.equips()[1],
      Moghunter.scStatus_ShieldX,
      Moghunter.scStatus_ShieldY
    );
    this.drawItemName(
      this._actor.equips()[2],
      Moghunter.scStatus_HelmetX,
      Moghunter.scStatus_HelmetY
    );
    this.drawItemName(
      this._actor.equips()[3],
      Moghunter.scStatus_ArmorX,
      Moghunter.scStatus_ArmorY
    );
    this.drawItemName(
      this._actor.equips()[4],
      Moghunter.scStatus_AccX,
      Moghunter.scStatus_AccY
    );
    this.drawActorClass(
      this._actor,
      Moghunter.scStatus_ClassX,
      Moghunter.scStatus_ClassY
    );
    this.drawTextEx(
      this._actor.profile(),
      Moghunter.scStatus_ProfileX,
      Moghunter.scStatus_ProfileY
    );
  }
};
...
MetersStatusM.prototype.update = function () {
  ...
  if (!this._meters && this._meterImg1.isReady()) {
    this.createMeters();
  }
  if (this._meters && this._actor) {
    this.updateMeters();
  }
};
