...
/*:
 * @target MV
 * @plugindesc [Ver2.0.0]Play voice SE at battle when actor does spcified action
...
/*:ja
 * @target MV
 * @plugindesc [Ver2.0.0]アクターの戦闘時の行動にボイスSEを設定します。
 * @author 神無月サスケ
 * 
 * @param ON switch ID
 * @text ボイス演奏スイッチID
...
(function () {
  ...
  var _Game_Actor_performRecovery = Game_Actor.prototype.performRecovery;
