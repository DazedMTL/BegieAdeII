...
Moghunter.scMenu_HPMeterY = Number(Moghunter.parameters['HP Meter Y-Axis'] || 75);
...
Moghunter.scMenu_TPMeterX = Number(Moghunter.parameters['TP Meter X-Axis'] || 17);
Moghunter.scMenu_TPMeterY = Number(Moghunter.parameters['TP Meter Y-Axis'] || 195);
Moghunter.scMenu_HPNumberX = Number(Moghunter.parameters['HP Number X-Axis'] || 100);
Moghunter.scMenu_HPNumberY = Number(Moghunter.parameters['HP Number Y-Axis'] || 75);
...
Moghunter.scMenu_TPNumberX = Number(Moghunter.parameters['TP Number X-Axis'] || 100);
Moghunter.scMenu_TPNumberY = Number(Moghunter.parameters['TP Number Y-Axis'] || 173);
Moghunter.scMenu_TPNumber2X = Number(Moghunter.parameters['TPMax Number X-Axis'] || 140);
Moghunter.scMenu_TPNumber2Y = Number(Moghunter.parameters['TPMax Number Y-Axis'] || 200);
...
Moghunter.scMenu_InyokuNumberX = Number(Moghunter.parameters['Inyoku X-Axis'] || 300);
Moghunter.scMenu_InyokuNumberY = Number(Moghunter.parameters['Inyoku Y-Axis'] || 200);
...
MCharStatus.prototype.createStatusNumber = function () {
	...
	this._text.bitmap.drawText(this._actor.agi, x + 125, y + 24 * 1, wid, hei, "right");
	this._text.bitmap.drawText(this._actor.luk, x + 125, y + 24 * 2, wid, hei, "right");
	this._text.bitmap.drawText(this._actor.currentExp(), x + 265, y, wid, hei, "right");
	this._text.bitmap.drawText($gameVariables.value(68), x + 265, y + 24 * 1, wid, hei, "right");
	this._text.bitmap.drawText(this._actor.nextRequiredExp(), x + 265, y + 24 * 2, wid, hei, "right");
	x = 0;
	y = 126;
	// H経験（左）
	const varNum = 43;
	this._text.bitmap.drawText($gameVariables.value(varNum), x, y, wid, hei, "right"); // 凌辱経験
	this._text.bitmap.drawText($gameVariables.value(varNum + 1), x, y + 24 * 1, wid, hei, "right"); // 緊縛経験
	this._text.bitmap.drawText($gameVariables.value(varNum + 2), x, y + 24 * 2, wid, hei, "right"); // 隷属経験
	this._text.bitmap.drawText($gameVariables.value(varNum + 3), x, y + 24 * 3, wid, hei, "right"); // 催眠経験
	this._text.bitmap.drawText($gameVariables.value(varNum + 4), x, y + 24 * 4, wid, hei, "right"); // 絶頂回数
	this._text.bitmap.drawText($gameVariables.value(varNum + 5), x, y + 24 * 5, wid, hei, "right"); // 自慰回数
	this._text.bitmap.drawText($gameVariables.value(varNum + 6), x, y + 24 * 6, wid, hei, "right"); // 露出経験
	this._text.bitmap.drawText($gameVariables.value(varNum + 7), x, y + 24 * 7, wid, hei, "right"); // 男根経験
	this._text.bitmap.drawText($gameVariables.value(varNum + 8), x, y + 24 * 8, wid, hei, "right"); // ふたなり愛撫経験
	// H経験（中)
	this._text.bitmap.drawText($gameVariables.value(varNum + 9), x + 125, y + 24 * 1, wid, hei, "right"); // キス経験
	this._text.bitmap.drawText($gameVariables.value(varNum + 10), x + 125, y + 24 * 2, wid, hei, "right"); // 口淫経験
	this._text.bitmap.drawText($gameVariables.value(varNum + 11), x + 125, y + 24 * 4, wid, hei, "right"); // 乳愛撫経験
	this._text.bitmap.drawText($gameVariables.value(varNum + 12), x + 125, y + 24 * 5, wid, hei, "right"); // パイズリ経験
	this._text.bitmap.drawText($gameVariables.value(varNum + 13), x + 125, y + 24 * 7, wid, hei, "right"); // 膣愛撫経験
	this._text.bitmap.drawText($gameVariables.value(varNum + 14), x + 125, y + 24 * 8, wid, hei, "right"); // 膣経験
	// H経験（右)
	this._text.bitmap.drawText($gameVariables.value(varNum + 15), x + 265, y + 24 * 1, wid, hei, "right"); // 肛門愛撫経験
	this._text.bitmap.drawText($gameVariables.value(varNum + 16), x + 265, y + 24 * 2, wid, hei, "right"); // アナル経験
	this._text.bitmap.drawText($gameVariables.value(varNum + 17), x + 245, y + 24 * 4, wid, hei, "right"); // 浴精液
	this._text.bitmap.drawText($gameVariables.value(varNum + 18), x + 245, y + 24 * 5, wid, hei, "right"); // 口内射精
	this._text.bitmap.drawText($gameVariables.value(varNum + 19), x + 245, y + 24 * 6, wid, hei, "right"); // 膣内射精
	this._text.bitmap.drawText($gameVariables.value(varNum + 20), x + 245, y + 24 * 7, wid, hei, "right"); // 肛内射精
	this._text.bitmap.drawText($gameVariables.value(varNum + 21), x + 245, y + 24 * 8, wid, hei, "right"); // ふたなり射精
	// 称号
	x = 552;
	y = 186;
	let switchNum = 129;
	if ($gameSwitches.value(switchNum)) {
		// ケツへこ騎士
		this._achievement_1 = new Sprite(ImageManager.loadMenusMain("achievement-1"));
	...
	if ($gameSwitches.value(switchNum + 1)) {
		this._achievement_2 = new Sprite(ImageManager.loadMenusMain("achievement-2"));
	...
	if ($gameSwitches.value(switchNum + 2)) {
		this._achievement_3 = new Sprite(ImageManager.loadMenusMain("achievement-3"));
	...
	if ($gameSwitches.value(switchNum + 3)) {
		this._achievement_4 = new Sprite(ImageManager.loadMenusMain("achievement-4"));
	...
	if ($gameSwitches.value(switchNum + 4)) {
		this._achievement_5 = new Sprite(ImageManager.loadMenusMain("achievement-5"));
	...
	if ($gameSwitches.value(switchNum + 5)) {
		this._achievement_6 = new Sprite(ImageManager.loadMenusMain("achievement-6"));
	...
	if ($gameSwitches.value(switchNum + 6)) {
		this._achievement_7 = new Sprite(ImageManager.loadMenusMain("achievement-7"));
	...
	if ($gameSwitches.value(switchNum + 7)) {
		this._achievement_8 = new Sprite(ImageManager.loadMenusMain("achievement-8"));
	...
	if ($gameSwitches.value(switchNum + 8)) {
		this._achievement_9 = new Sprite(ImageManager.loadMenusMain("achievement-9"));
	...
	if ($gameSwitches.value(switchNum + 9)) {
		this._achievement_10 = new Sprite(ImageManager.loadMenusMain("achievement-10"));
	...
	if ($gameSwitches.value(switchNum + 10)) {
		this._achievement_11 = new Sprite(ImageManager.loadMenusMain("achievement-11"));
	...
	if ($gameSwitches.value(switchNum + 11)) {
		this._achievement_12 = new Sprite(ImageManager.loadMenusMain("achievement-12"));
	...
	if ($gameSwitches.value(switchNum + 12)) {
		this._achievement_13 = new Sprite(ImageManager.loadMenusMain("achievement-13"));
	...
	switchNum = 121;
	// 膣処女／膣非処女／ヤリマン／ガバマン
	const cSuffix = $gameSwitches.value(switchNum + 3) ? 'd' : $gameSwitches.value(switchNum + 2) ? 'c' : $gameSwitches.value(switchNum + 1) ? 'b' : 'a';
	this._h_status_7 = new Sprite(ImageManager.loadMenusMain(`h-status-7${cSuffix}`));
	this._h_status_7.x = x;
	this._h_status_7.y = y + 46 * 3;
	this.addChild(this._h_status_7);

	// アナル処女／アナル非処女／ゆるケツ／ガバケツ
	const aSuffix = $gameSwitches.value(switchNum + 7) ? 'd' : $gameSwitches.value(switchNum + 6) ? 'c' : $gameSwitches.value(switchNum + 5) ? 'b' : 'a';
	this._h_status_8 = new Sprite(ImageManager.loadMenusMain(`h-status-8${aSuffix}`));
...
MCharStatus.prototype.createInyokuNumber = function () {
	...
	// todo
	this.refresh_number(this._iy_number, $gameVariables.value(1), this._NumberData, x)
};
...
MCharStatus.prototype.update = function () {
	...
	if (this._tpMeter) { this.updateMeter(this._tpMeter, this._tpMeterData, this._actor.tp, 100) };
