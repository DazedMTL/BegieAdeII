...
Moghunter.scEquip_HelpWindowX = Number(
  Moghunter.parameters["Help X-Axis"] || 0
);
Moghunter.scEquip_HelpWindowY = Number(
  Moghunter.parameters["Help Y-Axis"] || 516
);
Moghunter.scEquip_HelpLayoutX = Number(
  Moghunter.parameters["Help Layout X-Axis"] || 0
);
Moghunter.scEquip_HelpLayoutY = Number(
  Moghunter.parameters["Help Layout Y-Axis"] || -67
);
Moghunter.scEquip_ComWindowX = Number(
  Moghunter.parameters["Command X-Axis"] || 312
);
Moghunter.scEquip_ComWindowY = Number(
  Moghunter.parameters["Command Y-Axis"] || 10
);
Moghunter.scEquip_ComLayoutX = Number(
  Moghunter.parameters["Command Layout X-Axis"] || 15
);
Moghunter.scEquip_ComLayoutY = Number(
  Moghunter.parameters["Command Layout Y-Axis"] || 11
);
Moghunter.scEquip_SlotWindowX = Number(
  Moghunter.parameters["Slot X-Axis"] || 312
);
Moghunter.scEquip_SlotWindowY = Number(
  Moghunter.parameters["Slot Y-Axis"] || 70
);
Moghunter.scEquip_SlotLayoutX = Number(
  Moghunter.parameters["Slot Layout X-Axis"] || 22
);
Moghunter.scEquip_SlotLayoutY = Number(
  Moghunter.parameters["Slot Layout Y-Axis"] || 8
);
Moghunter.scEquip_ItemWindowX = Number(
  Moghunter.parameters["List X-Axis"] || 305
);
Moghunter.scEquip_ItemWindowY = Number(
  Moghunter.parameters["List Y-Axis"] || 280
);
Moghunter.scEquip_ItemLayoutX = Number(
  Moghunter.parameters["List Layout X-Axis"] || 0
);
Moghunter.scEquip_ItemLayoutY = Number(
  Moghunter.parameters["List Layout Y-Axis"] || 0
);
Moghunter.scEquip_StatusWindowX = Number(
  Moghunter.parameters["Status X-Axis"] || 10
);
Moghunter.scEquip_StatusWindowY = Number(
  Moghunter.parameters["Status Y-Axis"] || 120
);
Moghunter.scEquip_StatusLayoutX = Number(
  Moghunter.parameters["Status Layout X-Axis"] || 0
);
Moghunter.scEquip_StatusLayoutY = Number(
  Moghunter.parameters["Status Layout Y-Axis"] || 0
);
...
Scene_Equip.prototype.create = function () {
  ...
  this._itemWindow.width = this._slotWindow.width * 2 - 20;
...
Scene_Equip.prototype.createLayoutCommand = function () {
  this._layoutCommand = new Sprite(
    ImageManager.loadMenusequip("LayoutCommand")
  );
...
// * draw Text
//==============================
Window_EquipCommand.prototype.drawText = function (
  text,
  x,
  y,
  maxWidth,
...
Window_EquipStatus.prototype.refresh = function () {
  ...
  if (this._actor) {
    ...
    this.drawActorName(this._actor, this.textPadding(), 15);
    for (var i = 0; i < 6; i++) {
...
Window_EquipStatus.prototype.refreshFaceSprite = function () {
  this._faceSprite.bitmap = ImageManager.loadMenusFaces1(
