...
// INYOKU POSITION
Moghunter.ahud_inyoku_visible = String(Moghunter.parameters['Inyoku Visible'] || true);
Moghunter.ahud_inyoku_align = Number(Moghunter.parameters['Inyoku Align'] || 1);
Moghunter.ahud_inyoku_pos_x = Number(Moghunter.parameters['Inyoku X-Axis'] || 65);
Moghunter.ahud_inyoku_pos_y = Number(Moghunter.parameters['Inyoku Y-Axis'] || 153);
...
// ACP ICON POSITION
Moghunter.ahud_acp_icon_visible = String(Moghunter.parameters['ACP Icon Visible'] || 'false');
Moghunter.ahud_acp_icon_halfMode = String(Moghunter.parameters['ACP Icon Half Mode'] || 'false');
Moghunter.ahud_acp_icon_colorMax = Number(Moghunter.parameters['ACP Icon Max Colors'] || 2);
Moghunter.ahud_acp_icon_rows = Number(Moghunter.parameters['ACP Icon Max Rows'] || 10);
Moghunter.ahud_acp_icon_cols = Number(Moghunter.parameters['ACP Icon Max Columns'] || 2);
Moghunter.ahud_acp_icon_pos_x = Number(Moghunter.parameters['ACP Icon X-Axis'] || 143);
Moghunter.ahud_acp_icon_pos_y = Number(Moghunter.parameters['ACP Icon Y-Axis'] || 85);
Moghunter.ahud_acp_icon_space_x = Number(Moghunter.parameters['ACP Icon Space X'] || 0);
Moghunter.ahud_acp_icon_space_y = Number(Moghunter.parameters['ACP Icon Space Y'] || 0);
Moghunter.ahud_acp_icon_zoomAnime = String(Moghunter.parameters['ACP Icon Zoom Anime'] || 'true');

// LCP ICON POSITION
Moghunter.ahud_lcp_icon_visible = String(Moghunter.parameters['LCP Icon Visible'] || 'false');
Moghunter.ahud_lcp_icon_halfMode = String(Moghunter.parameters['LCP Icon Half Mode'] || 'false');
Moghunter.ahud_lcp_icon_colorMax = Number(Moghunter.parameters['LCP Icon Max Colors'] || 2);
Moghunter.ahud_lcp_icon_rows = Number(Moghunter.parameters['LCP Icon Max Rows'] || 10);
Moghunter.ahud_lcp_icon_cols = Number(Moghunter.parameters['LCP Icon Max Columns'] || 2);
Moghunter.ahud_lcp_icon_pos_x = Number(Moghunter.parameters['LCP Icon X-Axis'] || 143);
Moghunter.ahud_lcp_icon_pos_y = Number(Moghunter.parameters['LCP Icon Y-Axis'] || 85);
Moghunter.ahud_lcp_icon_space_x = Number(Moghunter.parameters['LCP Icon Space X'] || 0);
Moghunter.ahud_lcp_icon_space_y = Number(Moghunter.parameters['LCP Icon Space Y'] || 0);
Moghunter.ahud_lcp_icon_zoomAnime = String(Moghunter.parameters['LCP Icon Zoom Anime'] || 'true');
...
// ACP METER POSITION
Moghunter.ahud_acp_meter_visible = String(Moghunter.parameters['ACP Meter Visible'] || true);
Moghunter.ahud_acp_meter_pos_x = Number(Moghunter.parameters['ACP Meter X-Axis'] || 143);
Moghunter.ahud_acp_meter_pos_y = Number(Moghunter.parameters['ACP Meter Y-Axis'] || 85);
Moghunter.ahud_acp_meter_rotation = Number(Moghunter.parameters['ACP Meter Angle'] || 0);
Moghunter.ahud_acp_meter_flow = String(Moghunter.parameters['ACP Meter Flow Anime'] || false);
Moghunter.ahud_acp_flowSpd = Number(Moghunter.parameters['ACP Meter Flow Speed'] || 2);

// ACP NUMBER POSITION
Moghunter.ahud_acp_number_visible = String(Moghunter.parameters['ACP Number Visible'] || true);
Moghunter.ahud_acp_number_align = Number(Moghunter.parameters['ACP Number Align'] || 0);
Moghunter.ahud_acp_number_pos_x = Number(Moghunter.parameters['ACP Number X-Axis'] || 270);
Moghunter.ahud_acp_number_pos_y = Number(Moghunter.parameters['ACP Number Y-Axis'] || 70);
Moghunter.ahud_maxacp_number_visible = String(Moghunter.parameters['MaxACP Number Visible'] || false);
Moghunter.ahud_maxacp_number_pos_x = Number(Moghunter.parameters['MaxACP Number X-Axis'] || 125);
Moghunter.ahud_maxacp_number_pos_y = Number(Moghunter.parameters['MaxACP Number Y-Axis'] || 13);

// LCP METER POSITION
Moghunter.ahud_lcp_meter_visible = String(Moghunter.parameters['LCP Meter Visible'] || true);
Moghunter.ahud_lcp_meter_pos_x = Number(Moghunter.parameters['LCP Meter X-Axis'] || 143);
Moghunter.ahud_lcp_meter_pos_y = Number(Moghunter.parameters['LCP Meter Y-Axis'] || 85);
Moghunter.ahud_lcp_meter_rotation = Number(Moghunter.parameters['LCP Meter Angle'] || 0);
Moghunter.ahud_lcp_meter_flow = String(Moghunter.parameters['LCP Meter Flow Anime'] || false);
Moghunter.ahud_lcp_flowSpd = Number(Moghunter.parameters['LCP Meter Flow Speed'] || 2);

// LCP NUMBER POSITION
Moghunter.ahud_lcp_number_visible = String(Moghunter.parameters['LCP Number Visible'] || true);
Moghunter.ahud_lcp_number_align = Number(Moghunter.parameters['LCP Number Align'] || 0);
Moghunter.ahud_lcp_number_pos_x = Number(Moghunter.parameters['LCP Number X-Axis'] || 270);
Moghunter.ahud_lcp_number_pos_y = Number(Moghunter.parameters['LCP Number Y-Axis'] || 70);
Moghunter.ahud_maxlcp_number_visible = String(Moghunter.parameters['MaxLCP Number Visible'] || false);
Moghunter.ahud_maxlcp_number_pos_x = Number(Moghunter.parameters['MaxLCP Number X-Axis'] || 125);
Moghunter.ahud_maxlcp_number_pos_y = Number(Moghunter.parameters['MaxLCP Number Y-Axis'] || 13);

// Level NUMBER POSITION
Moghunter.ahud_level_number_visible = String(Moghunter.parameters['Level Number Visible'] || true);
Moghunter.ahud_level_number_align = Number(Moghunter.parameters['Level Number Align'] || 0);
Moghunter.ahud_level_number_pos_x = Number(Moghunter.parameters['Level Number X-Axis'] || 163);
Moghunter.ahud_level_number_pos_y = Number(Moghunter.parameters['Level Number Y-Axis'] || 71);
...
Actor_Hud.prototype.load_img = function () {
	...
	if (String(Moghunter.ahud_inyoku_visible) == "true") { this._inyoku_img = ImageManager.loadAHud("INYOKU_Number") };
	...
	if (String(Moghunter.ahud_acp_meter_visible) == "true") { this._acp_meter_img = ImageManager.loadAHud("ACP_Meter") };
	if (String(Moghunter.ahud_lcp_meter_visible) == "true") { this._lcp_meter_img = ImageManager.loadAHud("LCP_Meter") };
	...
	if (String(Moghunter.ahud_acp_icon_visible) == "true") { this._acp_icon_img = ImageManager.loadAHud("ACP_Icon") };
	if (String(Moghunter.ahud_lcp_icon_visible) == "true") { this._lcp_icon_img = ImageManager.loadAHud("LCP_Icon") };
	...
	if (String(Moghunter.ahud_acp_number_visible) == "true") { this._acp_number_img = ImageManager.loadAHud("ACP_Number") };
	if (String(Moghunter.ahud_lcp_number_visible) == "true") { this._lcp_number_img = ImageManager.loadAHud("LCP_Number") };
...
Actor_Hud.prototype.base_parameter_clear = function () {
	...
	this._acp_flow_speed = Moghunter.ahud_acp_flowSpd * 0.1;
	this._lcp_flow_speed = Moghunter.ahud_lcp_flowSpd * 0.1;
	this._hud_size = [0, 0];
};
...
Actor_Hud.prototype.need_refreh_bhud = function () {
	...
	if (this._variables != $gameVariables) { return true };
...
// * 淫欲度表示
//==============================
Actor_Hud.prototype.create_inyoku = function () {
	if (String(Moghunter.ahud_inyoku_visible) != "true") { return };
	if (this._inyoku) { for (var i = 0; i < this._inyoku.length; i++) { this.removeChild(this._inyoku[i]); } };
	if (this._variables.value(1) === -1) { return };
	this._inyoku = [];
	this._inyoku.align = Number(Moghunter.ahud_inyoku_align);
	this._inyoku_img_data = [this._inyoku_img.width, this._inyoku_img.height,
	this._inyoku_img.width / 10, this._inyoku_img.height / 2,
	this._pos_x + Moghunter.ahud_inyoku_pos_x,
	this._pos_y + Moghunter.ahud_inyoku_pos_y,
	];
	for (var i = 0; i < 3; i++) {
	...
	this.refresh_number(this._inyoku, this._inyoku_old, this._inyoku_img_data, this._inyoku_img_data[4], 1);
};
...
Actor_Hud.prototype.need_refresh_parameter = function (parameter) {
	switch (parameter) {
		...
		case 3:
			...
			break;
		case 4:
			if (this._acp_old[0] != this._variables.value(2)) { return true };
			if (this._acp_old[1] != 100) { return true };
			break;
		case 5:
			if (this._lcp_old[0] != this._variables.value(3)) { return true };
			if (this._lcp_old[1] != 100) { return true };
			break;
	};
	return false;
};
...
// * Create ACP Meter
//==============================
Actor_Hud.prototype.create_acp_meter = function () {
	if (String(Moghunter.ahud_acp_meter_visible) != "true") { return };
	this.removeChild(this._acp_meter_blue);
	this.removeChild(this._acp_meter_red);
	if (this._variables.value(2) === -1) { return };
	this._acp_meter_red = new Sprite(this._acp_meter_img);
	this._acp_meter_red.x = this._pos_x + Moghunter.ahud_acp_meter_pos_x;
	this._acp_meter_red.y = this._pos_y + Moghunter.ahud_acp_meter_pos_y;
	this._acp_meter_red.rotation = Moghunter.ahud_acp_meter_rotation * Math.PI / 180;
	...
	this._acp_meter_blue.rotation = this._acp_meter_red.rotation * Math.PI / 180;
	this._acp_meter_blue.setFrame(0, 0, 0, 0);
	this.addChild(this._acp_meter_blue);
	this._acp_old_ani[0] = this._variables.value(2);
	if (String(Moghunter.ahud_acp_meter_flow) === "true") {
...
// * Create ACP icon
//==============================
Actor_Hud.prototype.create_acp_icon = function () {
	if (String(Moghunter.ahud_acp_icon_visible) != "true") { return };
	if (this._acp_icons) {
	...
	if (this._variables.value(2) === -1) { return };
	var n_icons = Moghunter.ahud_acp_icon_rows * Moghunter.ahud_acp_icon_cols;
	this._acp_icons = [];
	this._acp_icons.iconMode = String(Moghunter.ahud_acp_icon_halfMode) == "true" ? true : false;
	this._acp_iconsB = [];

	this._acp_iconsB.iconMode = this._acp_icons.iconMode;
	this._acp_IconZoomAnime = String(Moghunter.ahud_acp_icon_zoomAnime) == "true" ? true : false;
	var colors = Math.max(Moghunter.ahud_acp_icon_colorMax, 2)
	...
	for (var i = 0; i < n_icons; i++) {
		...
		this._acp_iconsB[i].rows = Moghunter.ahud_acp_icon_rows;
		this._acp_iconsB[i].cols = Moghunter.ahud_acp_icon_cols;
		this._acp_iconsB[i].org = [this._pos_x + Moghunter.ahud_acp_icon_pos_x - cw, this._pos_y + Moghunter.ahud_acp_icon_pos_y - ch];
		this._acp_iconsB[i].spc = [Moghunter.ahud_acp_icon_space_x, Moghunter.ahud_acp_icon_space_y];
		this._acp_iconsB[i].zoomA = this._acp_IconZoomAnime;
		this._acp_iconsB[i].zoomData = [0, 0, 0, 1.00];
	...
	for (var i = 0; i < n_icons; i++) {
		...
		// this._acp_icons[i].colorMax = Math.max(Moghunter.ahud_acp_icon_colorMax, 2);
		this._acp_icons[i].anchor.x = 0.5;
		this._acp_icons[i].anchor.y = 0.5;
		this._acp_icons[i].rows = Moghunter.ahud_acp_icon_rows;
		this._acp_icons[i].cols = Moghunter.ahud_acp_icon_cols;
		this._acp_icons[i].org = [this._pos_x + Moghunter.ahud_acp_icon_pos_x - cw, this._pos_y + Moghunter.ahud_acp_icon_pos_y - ch];
		this._acp_icons[i].spc = [Moghunter.ahud_acp_icon_space_x, Moghunter.ahud_acp_icon_space_y];
		this._acp_icons[i].zoomA = this._acp_IconZoomAnime;
		this._acp_icons[i].zoomData = [0, 0, 0, 1.00];
...
// * Create ACP Number
//==============================
Actor_Hud.prototype.create_acp_number = function () {
	if (String(Moghunter.ahud_acp_number_visible) != "true") { return };
	if (this._acp_number) { for (var i = 0; i < this._acp_number.length; i++) { this.removeChild(this._acp_number[i]); } };
	if (this._variables.value(2) === -1) { return };
	this._acp_number = [];
	this._acp_number.align = Number(Moghunter.ahud_acp_number_align);
	this._acp_img_data = [this._acp_number_img.width, this._acp_number_img.height,
	this._acp_number_img.width / 10, this._acp_number_img.height / 2,
	this._pos_x + Moghunter.ahud_acp_number_pos_x,
	this._pos_y + Moghunter.ahud_acp_number_pos_y,
	];
	for (var i = 0; i < 5; i++) {
	...
	this.refresh_number(this._acp_number, this._acp_number_old, this._acp_img_data, this._acp_img_data[4], 0);
};

//==============================
// * Create maxACP Number
//==============================
Actor_Hud.prototype.create_maxacp_number = function () {
	if (String(Moghunter.ahud_maxacp_number_visible) != "true") { return };
	if (this._maxacp_number) { for (var i = 0; i < this._maxacp_number.length; i++) { this.removeChild(this._maxacp_number[i]); } };
	if (this._variables.value(2) === -1) { return };
	this._maxacp_number = [];
	this._maxacp_number.align = Number(Moghunter.ahud_acp_number_align);
	this._maxacp_img_data = [this._maxacp_number_img.width, this._maxacp_number_img.height,
	this._maxacp_number_img.width / 10, this._maxacp_number_img.height / 2,
	this._pos_x + Moghunter.ahud_maxacp_number_pos_x,
	this._pos_y + Moghunter.ahud_maxacp_number_pos_y,
	];
	for (var i = 0; i < 5; i++) {
	...
	this.refresh_number(this._maxacp_number, this._maxacp_number_old, this._maxacp_img_data, this._maxacp_img_data[4], 0);
};

//==============================
// * Update ACP
//==============================
Actor_Hud.prototype.update_acp = function () {
	// 変数2が-1になったら表示消す
	...
	// 	};
	// 	if (this._acp_number) {
	// 		for (var i = 0; i < this._acp_number.length; i++) { this.removeChild(this._acp_number[i]); };
	// 	};
	// 	if (this._maxacp_number) {
	// 		for (var i = 0; i < this._maxacp_number.length; i++) { this.removeChild(this._maxacp_number[i]); };
	// 	};
	// 	if (this._acp_icons) {
	// 		for (var i = 0; i < this._acp_icons.length; i++) { this.removeChild(this._acp_icons[i]); };
	// 		for (var i = 0; i < this._acp_iconsB.length; i++) { this.removeChild(this._acp_iconsB[i]); };
	// 	};
	// };
	if (this._acp_meter_blue) {
		if (this._acp_flow[0]) {
			if (this._acp_old[1] != 100) {
				...
				this.refresh_meter_flow(this._acp_meter_red, this._variables.value(2), 100, 1, $gameSystem._ahud_flowData[3]);
			};
			this.refresh_meter_flow(this._acp_meter_blue, this._variables.value(2), 100, 0, $gameSystem._ahud_flowData[3]);
			var dif_meter = this.update_dif(this._acp_old_ani[0], this._variables.value(2), 160)
			if (this._acp_old_ani[0] != dif_meter) {
				this._acp_old_ani[0] = dif_meter;
				this.refresh_meter_flow(this._acp_meter_red, this._acp_old_ani[0], 100, 1, $gameSystem._ahud_flowData[3]);
			};
			$gameSystem._ahud_flowData[3] += this._acp_flow_speed;
			if ($gameSystem._ahud_flowData[3] > this._acp_flow[3]) { $gameSystem._ahud_flowData[3] = 0 };
		}
		else {
			if (this.need_refresh_parameter(5)) {
				this.refresh_meter(this._acp_meter_blue, this._variables.value(2), 100, 0, 2, 0);
				this._acp_old = [this._variables.value(2), 100];
			};
			var dif_meter = this.update_dif(this._acp_old_ani[0], this._variables.value(2), 160)
			if (this._acp_old_ani[0] != dif_meter) {
				this._acp_old_ani[0] = dif_meter;
				this.refresh_meter(this._acp_meter_red, this._acp_old_ani[0], 100, 1, 2, 0);
			};
		};
	};
	if (this._acp_number) {
		var dif_number = this.update_dif(this._acp_number_old, this._variables.value(2), 30)
	...
	if (this._acp_icons) {
		if (this._acp_icon_old[0] != this._variables.value(2) || this._acp_icon_old[1] != 100) {
			this._acp_icon_old[0] = this._variables.value(2);
			this._acp_icon_old[1] = 100;
			this.refresh_icons(this._acp_iconsB, this._acp_icon_img, this._variables.value(2), 100, 0);
			this.refresh_icons(this._acp_icons, this._acp_icon_img, this._variables.value(2), 100, 1);
		};
		if (this._acp_IconZoomAnime) { this.updateIconZoomAnime(this._acp_icons) };
	};
};
...
// * Create LCP Meter
//==============================
Actor_Hud.prototype.create_lcp_meter = function () {
	if (String(Moghunter.ahud_lcp_meter_visible) != "true") { return };
	this.removeChild(this._lcp_meter_blue);
	this.removeChild(this._lcp_meter_red);
	if (this._variables.value(3) === -1) { return };
	this._lcp_meter_red = new Sprite(this._lcp_meter_img);
	this._lcp_meter_red.x = this._pos_x + Moghunter.ahud_lcp_meter_pos_x;
	this._lcp_meter_red.y = this._pos_y + Moghunter.ahud_lcp_meter_pos_y;
	this._lcp_meter_red.rotation = Moghunter.ahud_lcp_meter_rotation * Math.PI / 180;
	...
	this._lcp_meter_blue.rotation = this._lcp_meter_red.rotation * Math.PI / 180;
	this._lcp_meter_blue.setFrame(0, 0, 0, 0);
	this.addChild(this._lcp_meter_blue);
	this._lcp_old_ani[0] = this._variables.value(3);
	if (String(Moghunter.ahud_lcp_meter_flow) === "true") {
...
// * Create LCP icon
//==============================
Actor_Hud.prototype.create_lcp_icon = function () {
	if (String(Moghunter.ahud_lcp_icon_visible) != "true") { return };
	if (this._lcp_icons) {
	...
	if (this._variables.value(3) === -1) { return };
	var n_icons = Moghunter.ahud_lcp_icon_rows * Moghunter.ahud_lcp_icon_cols;
	this._lcp_icons = [];
	this._lcp_icons.iconMode = String(Moghunter.ahud_lcp_icon_halfMode) == "true" ? true : false;
	this._lcp_iconsB = [];

	this._lcp_iconsB.iconMode = this._lcp_icons.iconMode;
	this._lcp_IconZoomAnime = String(Moghunter.ahud_lcp_icon_zoomAnime) == "true" ? true : false;
	var colors = Math.max(Moghunter.ahud_lcp_icon_colorMax, 2)
	...
	for (var i = 0; i < n_icons; i++) {
		...
		this._lcp_iconsB[i].rows = Moghunter.ahud_lcp_icon_rows;
		this._lcp_iconsB[i].cols = Moghunter.ahud_lcp_icon_cols;
		this._lcp_iconsB[i].org = [this._pos_x + Moghunter.ahud_lcp_icon_pos_x - cw, this._pos_y + Moghunter.ahud_lcp_icon_pos_y - ch];
		this._lcp_iconsB[i].spc = [Moghunter.ahud_lcp_icon_space_x, Moghunter.ahud_lcp_icon_space_y];
		this._lcp_iconsB[i].zoomA = this._lcp_IconZoomAnime;
		this._lcp_iconsB[i].zoomData = [0, 0, 0, 1.00];
	...
	for (var i = 0; i < n_icons; i++) {
		...
		// this._lcp_icons[i].colorMax = Math.max(Moghunter.ahud_lcp_icon_colorMax, 2);
		this._lcp_icons[i].anchor.x = 0.5;
		this._lcp_icons[i].anchor.y = 0.5;
		this._lcp_icons[i].rows = Moghunter.ahud_lcp_icon_rows;
		this._lcp_icons[i].cols = Moghunter.ahud_lcp_icon_cols;
		this._lcp_icons[i].org = [this._pos_x + Moghunter.ahud_lcp_icon_pos_x - cw, this._pos_y + Moghunter.ahud_lcp_icon_pos_y - ch];
		this._lcp_icons[i].spc = [Moghunter.ahud_lcp_icon_space_x, Moghunter.ahud_lcp_icon_space_y];
		this._lcp_icons[i].zoomA = this._lcp_IconZoomAnime;
		this._lcp_icons[i].zoomData = [0, 0, 0, 1.00];
...
// * Create LCP Number
//==============================
Actor_Hud.prototype.create_lcp_number = function () {
	if (String(Moghunter.ahud_lcp_number_visible) != "true") { return };
	if (this._lcp_number) { for (var i = 0; i < this._lcp_number.length; i++) { this.removeChild(this._lcp_number[i]); } };
	if (this._variables.value(3) === -1) { return };
	this._lcp_number = [];
	this._lcp_number.align = Number(Moghunter.ahud_lcp_number_align);
	this._lcp_img_data = [this._lcp_number_img.width, this._lcp_number_img.height,
	this._lcp_number_img.width / 10, this._lcp_number_img.height / 2,
	this._pos_x + Moghunter.ahud_lcp_number_pos_x,
	this._pos_y + Moghunter.ahud_lcp_number_pos_y,
	];
	for (var i = 0; i < 5; i++) {
	...
	this.refresh_number(this._lcp_number, this._lcp_number_old, this._lcp_img_data, this._lcp_img_data[4], 0);
};

//==============================
// * Create maxLCP Number
//==============================
Actor_Hud.prototype.create_maxlcp_number = function () {
	if (String(Moghunter.ahud_maxlcp_number_visible) != "true") { return };
	if (this._maxlcp_number) { for (var i = 0; i < this._maxlcp_number.length; i++) { this.removeChild(this._maxlcp_number[i]); } };
	if (this._variables.value(3) === -1) { return };
	this._maxlcp_number = [];
	this._maxlcp_number.align = Number(Moghunter.ahud_lcp_number_align);
	this._maxlcp_img_data = [this._maxlcp_number_img.width, this._maxlcp_number_img.height,
	this._maxlcp_number_img.width / 10, this._maxlcp_number_img.height / 2,
	this._pos_x + Moghunter.ahud_maxlcp_number_pos_x,
	this._pos_y + Moghunter.ahud_maxlcp_number_pos_y,
	];
	for (var i = 0; i < 5; i++) {
	...
	this.refresh_number(this._maxlcp_number, this._maxlcp_number_old, this._maxlcp_img_data, this._maxlcp_img_data[4], 0);
};

//==============================
// * Update LCP
//==============================
Actor_Hud.prototype.update_lcp = function () {
	// 変数2が-1になったら表示消す
	...
	if (this._lcp_meter_blue) {
		if (this._lcp_flow[0]) {
			if (this._lcp_old[1] != 100) {
				...
				this.refresh_meter_flow(this._lcp_meter_red, this._variables.value(3), 100, 1, $gameSystem._ahud_flowData[4]);
			};
			this.refresh_meter_flow(this._lcp_meter_blue, this._variables.value(3), 100, 0, $gameSystem._ahud_flowData[4]);
			var dif_meter = this.update_dif(this._lcp_old_ani[0], this._variables.value(3), 160)
			if (this._lcp_old_ani[0] != dif_meter) {
				this._lcp_old_ani[0] = dif_meter;
				this.refresh_meter_flow(this._lcp_meter_red, this._lcp_old_ani[0], 100, 1, $gameSystem._ahud_flowData[4]);
			};
			$gameSystem._ahud_flowData[4] += this._lcp_flow_speed;
			if ($gameSystem._ahud_flowData[4] > this._lcp_flow[3]) { $gameSystem._ahud_flowData[4] = 0 };
		}
		else {
			if (this.need_refresh_parameter(5)) {
				this.refresh_meter(this._lcp_meter_blue, this._variables.value(3), 100, 0, 2, 0);
				this._lcp_old = [this._variables.value(3), 100];
			};
			var dif_meter = this.update_dif(this._lcp_old_ani[0], this._variables.value(3), 160)
			if (this._lcp_old_ani[0] != dif_meter) {
				this._lcp_old_ani[0] = dif_meter;
				this.refresh_meter(this._lcp_meter_red, this._lcp_old_ani[0], 100, 1, 2, 0);
			};
		};
	};
	if (this._lcp_number) {
		var dif_number = this.update_dif(this._lcp_number_old, this._variables.value(3), 30)
	...
	if (this._lcp_icons) {
		if (this._lcp_icon_old[0] != this._variables.value(3) || this._lcp_icon_old[1] != 100) {
			this._lcp_icon_old[0] = this._variables.value(3);
			this._lcp_icon_old[1] = 100;
			this.refresh_icons(this._lcp_iconsB, this._lcp_icon_img, this._variables.value(3), 100, 0);
			this.refresh_icons(this._lcp_icons, this._lcp_icon_img, this._variables.value(3), 100, 1);
		};
		if (this._lcp_IconZoomAnime) { this.updateIconZoomAnime(this._lcp_icons) };
	};
};
...
// * Update Inyoku
//==============================
Actor_Hud.prototype.update_inyoku = function () {
	if (this._inyoku) {
		if (this._variables.value(1) === -1) {
			for (var i = 0; i < this._inyoku.length; i++) { this.removeChild(this._inyoku[i]); };
			return;
		};
		var dif_number = this.update_dif(this._inyoku_old, this._variables.value(1), 30)
