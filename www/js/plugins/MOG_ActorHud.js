...
Actor_Hud.prototype.load_img = function () {
  ...
  if (String(Moghunter.ahud_inyoku_visible) == "true") {
  ...
  if (String(Moghunter.ahud_acp_meter_visible) == "true") {
    this._acp_meter_img = ImageManager.loadAHud("ACP_Meter");
  }
  if (String(Moghunter.ahud_lcp_meter_visible) == "true") {
  ...
  if (String(Moghunter.ahud_acp_icon_visible) == "true") {
    this._acp_icon_img = ImageManager.loadAHud("ACP_Icon");
  }
  if (String(Moghunter.ahud_lcp_icon_visible) == "true") {
  ...
  if (String(Moghunter.ahud_acp_number_visible) == "true") {
    this._acp_number_img = ImageManager.loadAHud("ACP_Number");
  }
  if (String(Moghunter.ahud_lcp_number_visible) == "true") {
...
Actor_Hud.prototype.create_acp_meter = function () {
  ...
  this._acp_meter_red.rotation =
    (Moghunter.ahud_acp_meter_rotation * Math.PI) / 180;
...
Actor_Hud.prototype.create_acp_icon = function () {
  ...
  this._acp_icons.iconMode =
    String(Moghunter.ahud_acp_icon_halfMode) == "true" ? true : false;
  this._acp_iconsB = [];

  this._acp_iconsB.iconMode = this._acp_icons.iconMode;
  this._acp_IconZoomAnime =
    String(Moghunter.ahud_acp_icon_zoomAnime) == "true" ? true : false;
  ...
  for (var i = 0; i < n_icons; i++) {
    ...
    this._acp_iconsB[i].org = [
      this._pos_x + Moghunter.ahud_acp_icon_pos_x - cw,
      this._pos_y + Moghunter.ahud_acp_icon_pos_y - ch,
    ];
    this._acp_iconsB[i].spc = [
      Moghunter.ahud_acp_icon_space_x,
      Moghunter.ahud_acp_icon_space_y,
    ];
...
Actor_Hud.prototype.create_maxacp_number = function () {
  if (String(Moghunter.ahud_maxacp_number_visible) != "true") {
    return;
  }
...
Actor_Hud.prototype.update_acp = function () {
  ...
  if (this._acp_meter_blue) {
    if (this._acp_flow[0]) {
      ...
      if ($gameSystem._ahud_flowData[3] > this._acp_flow[3]) {
        $gameSystem._ahud_flowData[3] = 0;
      }
    } else {
...
Actor_Hud.prototype.create_lcp_meter = function () {
  ...
  this._lcp_meter_red.rotation =
    (Moghunter.ahud_lcp_meter_rotation * Math.PI) / 180;
...
Actor_Hud.prototype.create_lcp_icon = function () {
  ...
  this._lcp_icons.iconMode =
    String(Moghunter.ahud_lcp_icon_halfMode) == "true" ? true : false;
  this._lcp_iconsB = [];

  this._lcp_iconsB.iconMode = this._lcp_icons.iconMode;
  this._lcp_IconZoomAnime =
    String(Moghunter.ahud_lcp_icon_zoomAnime) == "true" ? true : false;
  ...
  for (var i = 0; i < n_icons; i++) {
    ...
    this._lcp_iconsB[i].org = [
      this._pos_x + Moghunter.ahud_lcp_icon_pos_x - cw,
      this._pos_y + Moghunter.ahud_lcp_icon_pos_y - ch,
    ];
    this._lcp_iconsB[i].spc = [
      Moghunter.ahud_lcp_icon_space_x,
      Moghunter.ahud_lcp_icon_space_y,
    ];
...
Actor_Hud.prototype.create_maxlcp_number = function () {
  if (String(Moghunter.ahud_maxlcp_number_visible) != "true") {
    return;
  }
...
Actor_Hud.prototype.update_lcp = function () {
  ...
  if (this._lcp_meter_blue) {
    if (this._lcp_flow[0]) {
      ...
      if ($gameSystem._ahud_flowData[4] > this._lcp_flow[3]) {
        $gameSystem._ahud_flowData[4] = 0;
      }
    } else {
      if (this.need_refresh_parameter(5)) {
        this.refresh_meter(
