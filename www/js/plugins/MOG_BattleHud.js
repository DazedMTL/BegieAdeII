...
// ACP METER POSITION
Moghunter.bhud_acp_meter_visible = String(Moghunter.parameters['ACP Meter Visible'] || true);
Moghunter.bhud_acp_meter_pos_x = Number(Moghunter.parameters['ACP Meter X-Axis'] || 143);
Moghunter.bhud_acp_meter_pos_y = Number(Moghunter.parameters['ACP Meter Y-Axis'] || 85);
Moghunter.bhud_acp_meter_rotation = Number(Moghunter.parameters['ACP Meter Angle'] || 0);
Moghunter.bhud_acp_meter_flow = String(Moghunter.parameters['ACP Meter Flow Anime'] || false);
Moghunter.bhud_acp_flowSpd = Number(Moghunter.parameters['ACP Meter Flow Speed'] || 2);

// ACP NUMBER POSITION
Moghunter.bhud_acp_number_visible = String(Moghunter.parameters['ACP Number Visible'] || true);
Moghunter.bhud_acp_number_align = Number(Moghunter.parameters['ACP Number Align'] || 0);
Moghunter.bhud_acp_number_pos_x = Number(Moghunter.parameters['ACP Number X-Axis'] || 270);
Moghunter.bhud_acp_number_pos_y = Number(Moghunter.parameters['ACP Number Y-Axis'] || 70);
Moghunter.bhud_maxacp_number_visible = String(Moghunter.parameters['MaxACP Number Visible'] || false);
Moghunter.bhud_maxacp_number_pos_x = Number(Moghunter.parameters['MaxACP Number X-Axis'] || 125);
Moghunter.bhud_maxacp_number_pos_y = Number(Moghunter.parameters['MaxACP Number Y-Axis'] || 13);

// ACP ICON POSITION
Moghunter.bhud_acp_icon_visible = String(Moghunter.parameters['ACP Icon Visible'] || 'false');
Moghunter.bhud_acp_icon_halfMode = String(Moghunter.parameters['ACP Icon Half Mode'] || 'false');
Moghunter.bhud_acp_icon_colorMax = Number(Moghunter.parameters['ACP Icon Max Colors'] || 2);
Moghunter.bhud_acp_icon_rows = Number(Moghunter.parameters['ACP Icon Max Rows'] || 10);
Moghunter.bhud_acp_icon_cols = Number(Moghunter.parameters['ACP Icon Max Columns'] || 2);
Moghunter.bhud_acp_icon_pos_x = Number(Moghunter.parameters['ACP Icon X-Axis'] || 143);
Moghunter.bhud_acp_icon_pos_y = Number(Moghunter.parameters['ACP Icon Y-Axis'] || 85);
Moghunter.bhud_acp_icon_space_x = Number(Moghunter.parameters['ACP Icon Space X'] || 0);
Moghunter.bhud_acp_icon_space_y = Number(Moghunter.parameters['ACP Icon Space Y'] || 0);
Moghunter.bhud_acp_icon_zoomAnime = String(Moghunter.parameters['ACP Icon Zoom Anime'] || 'true');

// LCP METER POSITION
Moghunter.bhud_lcp_meter_visible = String(Moghunter.parameters['LCP Meter Visible'] || true);
Moghunter.bhud_lcp_meter_pos_x = Number(Moghunter.parameters['LCP Meter X-Axis'] || 143);
Moghunter.bhud_lcp_meter_pos_y = Number(Moghunter.parameters['LCP Meter Y-Axis'] || 85);
Moghunter.bhud_lcp_meter_rotation = Number(Moghunter.parameters['LCP Meter Angle'] || 0);
Moghunter.bhud_lcp_meter_flow = String(Moghunter.parameters['LCP Meter Flow Anime'] || false);
Moghunter.bhud_lcp_flowSpd = Number(Moghunter.parameters['LCP Meter Flow Speed'] || 2);

// LCP NUMBER POSITION
Moghunter.bhud_lcp_number_visible = String(Moghunter.parameters['LCP Number Visible'] || true);
Moghunter.bhud_lcp_number_align = Number(Moghunter.parameters['LCP Number Align'] || 0);
Moghunter.bhud_lcp_number_pos_x = Number(Moghunter.parameters['LCP Number X-Axis'] || 270);
Moghunter.bhud_lcp_number_pos_y = Number(Moghunter.parameters['LCP Number Y-Axis'] || 70);
Moghunter.bhud_maxlcp_number_visible = String(Moghunter.parameters['MaxLCP Number Visible'] || false);
Moghunter.bhud_maxlcp_number_pos_x = Number(Moghunter.parameters['MaxLCP Number X-Axis'] || 125);
Moghunter.bhud_maxlcp_number_pos_y = Number(Moghunter.parameters['MaxLCP Number Y-Axis'] || 13);

// LCP ICON POSITION
Moghunter.bhud_lcp_icon_visible = String(Moghunter.parameters['LCP Icon Visible'] || 'false');
Moghunter.bhud_lcp_icon_halfMode = String(Moghunter.parameters['LCP Icon Half Mode'] || 'false');
Moghunter.bhud_lcp_icon_colorMax = Number(Moghunter.parameters['LCP Icon Max Colors'] || 2);
Moghunter.bhud_lcp_icon_rows = Number(Moghunter.parameters['LCP Icon Max Rows'] || 10);
Moghunter.bhud_lcp_icon_cols = Number(Moghunter.parameters['LCP Icon Max Columns'] || 2);
Moghunter.bhud_lcp_icon_pos_x = Number(Moghunter.parameters['LCP Icon X-Axis'] || 143);
Moghunter.bhud_lcp_icon_pos_y = Number(Moghunter.parameters['LCP Icon Y-Axis'] || 85);
Moghunter.bhud_lcp_icon_space_x = Number(Moghunter.parameters['LCP Icon Space X'] || 0);
Moghunter.bhud_lcp_icon_space_y = Number(Moghunter.parameters['LCP Icon Space Y'] || 0);
Moghunter.bhud_lcp_icon_zoomAnime = String(Moghunter.parameters['LCP Icon Zoom Anime'] || 'true');

// INYOKU POSITION
Moghunter.bhud_inyoku_visible = String(Moghunter.parameters['Inyoku Visible'] || true);
Moghunter.bhud_inyoku_align = Number(Moghunter.parameters['Inyoku Align'] || 1);
Moghunter.bhud_inyoku_pos_x = Number(Moghunter.parameters['Inyoku X-Axis'] || 65);
Moghunter.bhud_inyoku_pos_y = Number(Moghunter.parameters['Inyoku Y-Axis'] || 153);

// Level NUMBER POSITION
Moghunter.bhud_level_number_visible = String(Moghunter.parameters['Level Number Visible'] || true);
Moghunter.bhud_level_number_align = Number(Moghunter.parameters['Level Number Align'] || 0);
Moghunter.bhud_level_number_pos_x = Number(Moghunter.parameters['Level Number X-Axis'] || 163);
Moghunter.bhud_level_number_pos_y = Number(Moghunter.parameters['Level Number Y-Axis'] || 71);
...
Battle_Hud.prototype.load_img = function () {
	...
	if (String(Moghunter.bhud_inyoku_visible) == "true") { this._inyoku_img = ImageManager.loadAHud("INYOKU_Number") };
	if (String(Moghunter.bhud_level_number_visible) == "true") { this._level_number_img = ImageManager.loadAHud("LV_Number") };
	...
	if (String(Moghunter.bhud_acp_meter_visible) == "true") { this._acp_meter_img = ImageManager.loadAHud("ACP_Meter") };
	if (String(Moghunter.bhud_lcp_meter_visible) == "true") { this._lcp_meter_img = ImageManager.loadAHud("LCP_Meter") };
	if (String(Moghunter.bhud_acp_icon_visible) == "true") { this._acp_icon_img = ImageManager.loadAHud("ACP_Icon") };
	if (String(Moghunter.bhud_lcp_icon_visible) == "true") { this._lcp_icon_img = ImageManager.loadAHud("LCP_Icon") };
	...
	if (String(Moghunter.bhud_acp_number_visible) == "true") { this._acp_number_img = ImageManager.loadAHud("ACP_Number") };
	if (String(Moghunter.bhud_lcp_number_visible) == "true") { this._lcp_number_img = ImageManager.loadAHud("LCP_Number") };
...
Battle_Hud.prototype.create_inyoku = function () {
	if (String(Moghunter.bhud_inyoku_visible) != "true") { return };
	...
	this.refresh_number2(this._inyoku, this._inyoku_old, this._inyoku_img_data, this._inyoku_img_data[4], 1);
};
...
Battle_Hud.prototype.create_level_number = function () {
	if (String(Moghunter.bhud_level_number_visible) != "true") { return };
	...
	this.refresh_number2(this._level_number, this._level_number_old, this._level_img_data, this._level_img_data[4], 1);
};
...
// * Refresh Number
//==============================
Battle_Hud.prototype.refresh_number2 = function (sprites, value, img_data, x, center) {
	numbers = Math.abs(value).toString().split("");
	for (var i = 0; i < sprites.length; i++) {
		sprites[i].visible = false;
		if (i > numbers.length) { return };
...
Battle_Hud.prototype.create_acp_meter = function () {
	if (String(Moghunter.bhud_acp_meter_visible) != "true") { return };
	...
	this._acp_meter_red.rotation = Moghunter.bhud_acp_meter_rotation * Math.PI / 180;
...
Battle_Hud.prototype.create_acp_number = function () {
	if (String(Moghunter.bhud_acp_number_visible) != "true") { return };
	...
	this.refresh_number2(this._acp_number, this._acp_number_old, this._acp_img_data, this._acp_img_data[4], 0);
};
...
Battle_Hud.prototype.create_maxacp_number = function () {
	if (String(Moghunter.bhud_maxacp_number_visible) != "true") { return };
	...
	this.refresh_number2(this._maxacp_number, this._maxacp_number_old, this._maxacp_img_data, this._maxacp_img_data[4], 0);
};
...
Battle_Hud.prototype.create_acp_icon = function () {
	if (String(Moghunter.bhud_acp_icon_visible) != "true") { return };
	if (this._acp_icons) {
	...
	this._acp_icons = [];
	this._acp_icons.iconMode = String(Moghunter.bhud_acp_icon_halfMode) == "true" ? true : false;
	this._acp_iconsB = [];

	this._acp_iconsB.iconMode = this._acp_icons.iconMode;
	this._acp_IconZoomAnime = String(Moghunter.bhud_acp_icon_zoomAnime) == "true" ? true : false;
	...
	for (var i = 0; i < n_icons; i++) {
		...
		this._acp_iconsB[i].org = [this._pos_x + Moghunter.bhud_acp_icon_pos_x - cw, this._pos_y + Moghunter.bhud_acp_icon_pos_y - ch];
		this._acp_iconsB[i].spc = [Moghunter.bhud_acp_icon_space_x, Moghunter.bhud_acp_icon_space_y];
	...
	for (var i = 0; i < n_icons; i++) {
		...
		this._acp_icons[i].org = [this._pos_x + Moghunter.bhud_acp_icon_pos_x - cw, this._pos_y + Moghunter.bhud_acp_icon_pos_y - ch];
		this._acp_icons[i].spc = [Moghunter.bhud_acp_icon_space_x, Moghunter.bhud_acp_icon_space_y];
...
Battle_Hud.prototype.update_acp = function () {
	...
	if (this._acp_meter_blue) {
		if (this._acp_flow[0]) {
			if (this._acp_old[1] != 100) {
				...
				this.refresh_meter_flow(this._acp_meter_red, this._variables.value(2), 100, 1, $gameSystem._bhud_flowData[0]);
			};
			this.refresh_meter_flow(this._acp_meter_blue, this._variables.value(2), 100, 0, $gameSystem._bhud_flowData[0]);
			...
			if (this._acp_old_ani[0] != dif_meter) {
				...
				this.refresh_meter_flow(this._acp_meter_red, this._acp_old_ani[0], 100, 1, $gameSystem._bhud_flowData[0]);
			};
			$gameSystem._bhud_flowData[0] += this._acp_flow_speed;
			if ($gameSystem._bhud_flowData[0] > this._acp_flow[3]) { $gameSystem._bhud_flowData[0] = 0 };
		}
		else {
			if (this.need_refresh_parameter(3)) {
				this.refresh_meter(this._acp_meter_blue, this._variables.value(2), 100, 0);
				this._acp_old = [this._variables.value(2), 100];
			};
			var dif_meter = this.update_dif(this._acp_old_ani[0], this._variables.value(2), 160)
			if (this._acp_old_ani[0] != dif_meter) {
	...
	if (this._acp_icons) {
		if (this._acp_icon_old[0] != this._variables.value(2) || this._acp_icon_old[1] != 100) {
			...
			this.refreshIconNormalMode(this._acp_iconsB, this._acp_icon_img, this._variables.value(2), 100, 0);
			this.refreshIconNormalMode(this._acp_icons, this._acp_icon_img, this._variables.value(2), 100, 1);
		};
...
Battle_Hud.prototype.create_lcp_meter = function () {
	if (String(Moghunter.bhud_lcp_meter_visible) != "true") { return };
	...
	this._lcp_meter_red.rotation = Moghunter.bhud_lcp_meter_rotation * Math.PI / 180;
...
Battle_Hud.prototype.create_lcp_number = function () {
	if (String(Moghunter.bhud_lcp_number_visible) != "true") { return };
	...
	this.refresh_number2(this._lcp_number, this._lcp_number_old, this._lcp_img_data, this._lcp_img_data[4], 0);
};
...
Battle_Hud.prototype.create_maxlcp_number = function () {
	if (String(Moghunter.bhud_maxlcp_number_visible) != "true") { return };
	...
	this.refresh_number2(this._maxlcp_number, this._maxlcp_number_old, this._maxlcp_img_data, this._maxlcp_img_data[4], 0);
};
...
Battle_Hud.prototype.create_lcp_icon = function () {
	if (String(Moghunter.bhud_lcp_icon_visible) != "true") { return };
	if (this._lcp_icons) {
	...
	this._lcp_icons = [];
	this._lcp_icons.iconMode = String(Moghunter.bhud_lcp_icon_halfMode) == "true" ? true : false;
	this._lcp_iconsB = [];

	this._lcp_iconsB.iconMode = this._lcp_icons.iconMode;
	this._lcp_IconZoomAnime = String(Moghunter.bhud_lcp_icon_zoomAnime) == "true" ? true : false;
	...
	for (var i = 0; i < n_icons; i++) {
		...
		this._lcp_iconsB[i].org = [this._pos_x + Moghunter.bhud_lcp_icon_pos_x - cw, this._pos_y + Moghunter.bhud_lcp_icon_pos_y - ch];
		this._lcp_iconsB[i].spc = [Moghunter.bhud_lcp_icon_space_x, Moghunter.bhud_lcp_icon_space_y];
	...
	for (var i = 0; i < n_icons; i++) {
		...
		this._lcp_icons[i].org = [this._pos_x + Moghunter.bhud_lcp_icon_pos_x - cw, this._pos_y + Moghunter.bhud_lcp_icon_pos_y - ch];
		this._lcp_icons[i].spc = [Moghunter.bhud_lcp_icon_space_x, Moghunter.bhud_lcp_icon_space_y];
...
Battle_Hud.prototype.update_lcp = function () {
	...
	if (this._lcp_meter_blue) {
		if (this._lcp_flow[0]) {
			if (this._lcp_old[1] != 100) {
				...
				this.refresh_meter_flow(this._lcp_meter_red, this._variables.value(3), 100, 1, $gameSystem._bhud_flowData[0]);
			};
			this.refresh_meter_flow(this._lcp_meter_blue, this._variables.value(3), 100, 0, $gameSystem._bhud_flowData[0]);
			...
			if (this._lcp_old_ani[0] != dif_meter) {
				...
				this.refresh_meter_flow(this._lcp_meter_red, this._lcp_old_ani[0], 100, 1, $gameSystem._bhud_flowData[0]);
			};
			$gameSystem._bhud_flowData[0] += this._lcp_flow_speed;
			if ($gameSystem._bhud_flowData[0] > this._lcp_flow[3]) { $gameSystem._bhud_flowData[0] = 0 };
		}
		else {
			if (this.need_refresh_parameter(4)) {
				this.refresh_meter(this._lcp_meter_blue, this._variables.value(3), 100, 0);
				this._lcp_old = [this._variables.value(3), 100];
			};
			var dif_meter = this.update_dif(this._lcp_old_ani[0], this._variables.value(3), 160)
			if (this._lcp_old_ani[0] != dif_meter) {
	...
	if (this._lcp_icons) {
		if (this._lcp_icon_old[0] != this._variables.value(3) || this._lcp_icon_old[1] != 100) {
			...
			this.refreshIconNormalMode(this._lcp_iconsB, this._lcp_icon_img, this._variables.value(3), 100, 0);
			this.refreshIconNormalMode(this._lcp_icons, this._lcp_icon_img, this._variables.value(3), 100, 1);
		};
...
//==============================
Battle_Hud.prototype.refreshIconNormalMode = function (sprites, image, par, par_max, mode) {
	for (var i = 0; i < sprites.length; i++) {
		var icon = sprites[i];
...
// * set Color Index
//==============================
Battle_Hud.prototype.setColorIndex = function (i, mode, par, par_max, realvalue, isMaxValue, colorIndex, colorMax, maxvalue) {
	if (par === 0) { return 0 };
...
// * is Icon Visible
//==============================
Battle_Hud.prototype.isIconVisible = function (i, mode, par, par_max, realvalue, isMaxValue, colorIndex, colorIndex2, realvalue2, icon, maxvalue) {
	icon.opacity = 255;
	icon.blendMode = 0;
	if (mode === 0) {
...
// * is Icon Enabled
//==============================
Battle_Hud.prototype.isIconEnabled = function (i, mode, par, par_max, realvalue, iconMax, colorIndex, colorMax, maxvalue) {
